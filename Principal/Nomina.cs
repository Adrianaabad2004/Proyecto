...
namespace Principal
{
    public class Nomina
    {
        ...
        public void Imprimir(List<Empleado> list)
        {
            ...
            xlWorkBook.SaveAs("C:\\Users\\adriana\\Desktop\\Nomina-Excel.xls", Microsoft.Office.Interop.Excel.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
